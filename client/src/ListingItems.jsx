  ...
  return (
    ...
    w-full sm:w-[330px]">
        <Link to={`/listing/${lising._id}`}>
          ...
          <img src={lising.imageUrls[0]}
            alt="Lising cover"
            className="h-[320px] sm:h-[220px] w-full
            object-cover hover:scale-105 transition-scale
            duration-300"
          />
          ...
          <div className="p-3 flex flex-col gap-2 w-full">
            ...
            <p className="text-sm text-gray-600 line-clamp-2">{lising.description}</p>
             <p>{lising.Offer?lising.discountPrice.toLocaleString('en-US'):lising.toLocaleString('en-US')}
             ...
             <div className="flex gap-4">
                ...
                <div>
                    {lising.bathrooms > 1 ? `${lising.bathrooms} baths`:`${lising.bathrooms} baths`}
                </div>
             </div>
          </div>
